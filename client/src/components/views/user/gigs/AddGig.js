          ...
          <div className="tab-pane fade show active" id="overview">
             <form action="#" method="post" className="proposal-form">
                ...
                <div className="form-group row">
                   ...
                   <div className="col-md-9"><textarea name="proposal_title" rows="2" placeholder="I Will" className="form-control">logo making </textarea></div>
                ...
                <div className="form-group row">
                   ...
                   <div className="col-md-9">
                      <select name="proposal_cat_id" id="category" className="form-control mb-3">
                         ...
                         <option value="10"> Video Tutorials </option>
                         <option value="18"> On demand typing  </option>
                         <option value="19"> Radio anuncio </option>
                      </select>
                      <small className="form-text text-danger"></small>
                      <select name="proposal_child_id" id="sub-category" className="form-control">
                         ...
                         <option value='4'> Cartoons Caricatures </option>
                         <option value='5'> Flyers Posters </option>
                         <option value='6'> Book Covers & Packaging </option>
                         <option value='7'> Web &amp; Mobile Design </option>
                         <option value='8'> Social Media Design </option>
                         <option value='9'> Banner Ads </option>
                         <option value='12'> Photoshop Editing </option>
                         <option value='13'> 3D & 2D Models </option>
                         <option value='14'> T-Shirts </option>
                         <option value='15'> Presentation Design </option>
                         <option value='16'> Other </option>
                         <option value='107'> خدمات الترجمة </option>
                         <option value='110'> Hosting Services </option>
                         <option value='115'> facebook servic3 </option>
                         <option value='116'> o8uyoiu </option>
                      </select>
                   </div>
                </div>
                {/* <!--- form-group row Ends ---> */}
                ...
                <div className="form-group row">
                   {/* <!--- form-group row Starts ---> */}
                   <label className="col-md-3 control-label"> Enable Referrals </label>
                   <div className="col-md-9">
                      <select name="proposal_enable_referrals" className="proposal_enable_referrals form-control">
                ...
                {/* <!--- form-group row Ends ---> */}
                <div className="form-group row proposal_referral_money">
                   {/* <!--- form-group row Starts ---> */}
                   <label className="col-md-3 control-label"> Proposal Commission </label>
                   <div className="col-md-9">
                      <input type="number" name="proposal_referral_money" className="form-control" min="1" max="100" value="124" />
                ...
                <div className="form-group row">
                   ...
                   <div className="col-md-9"><input type="text" name="proposal_tags" className="form-control" data-role="tagsinput" value="logo1" /></div>
                   <small className="form-text text-danger"></small>
                </div>
                {/* <!--- form-group row Ends ---> */}
