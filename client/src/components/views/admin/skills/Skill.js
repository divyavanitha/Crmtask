...
const Skill = () => {
  ...
  useEffect(() => {
    ...
    $('body').on('click', '.edit', function (e) {
      e.preventDefault();
      history.push('/admin/skill/' + $(this).data('id') + '/edit')
    });
    ...
    $('#datatable').DataTable({
      ...
      "ajax": {
        ...
        dataFilter: function (response) {
          ...
          json.data = data.responseData.data.skills;
          console.log(json);
            ...
            <div className="col-sm-4">
              <div className="page-header float-left">
                <div className="page-title">
                  <h1><i className="menu-icon fa fa-cubes"></i> Skills </h1>
                </div>
              </div>
            </div>
              ...
              <div className="page-header float-right">
                <div className="page-title">
                  <ol className="breadcrumb text-right">
                    <li className="active"><Link className="btn btn-info" to="/admin/skill/add" >Add skill</Link></li>
                  </ol>
                </div>
              </div>
            </div> */}
        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="box box-block bg-white">
              <h5 className="mb-1">Skills
                <div className="rightBtn-Group">
                  <Link className="addMoreBtn" to="/admin/skill/add" ><span className="txt text-capitalize"> Add New <span className="amIcon"><i className="fa fa-plus"></i></span></span></Link>
                </div>
              </h5>
              <div className="">
