...
const Gigs = () => {
  ...
  useEffect(() => {
    ...
    $('#datatable').DataTable({
      ...
      "autoWidth": false,
      "ajax": {
        "url": '/api/admin/gigs?type=active',
        "type": "GET",
        data: function (data) {
      ...
      "columns": [
        ...
        { "data": "status" },
        {
          "data": function (data, type, row) {
            ...
            var button = `<a title="View Proposal" id="view-proposal" data-name=`+data.user.firstName+` data-title="`+data.title+`"> <i class="fa fa-eye"></i> </a> &nbsp;`
            ...
            <div className="box box-block bg-white">
                ...
                <div className="card-body">
                  ...
                  <li className="nav-item">
                    ...
                    <li className="nav-item">
                    <Link to="/admin/active/gigs"  className="nav-link active make-black">Active ({activeGig})</Link>
                    </li>
