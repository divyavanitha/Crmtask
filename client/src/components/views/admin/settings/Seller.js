                                        ...
                                        <div className="addFormBox">
                                            <form onSubmit={handleSubmit} encType="multipart/form-data">
                                                ...
                                                <div className="form-group row">
                                                    <label className="col-md-4 control-label"> Level One Seller Ratings % : </label>
                                                ...
                                                <div className="form-group row">
                                                    <label className="col-md-4 control-label"> Level One Completed Orders : </label>
                                                    <div className="col-md-6">
                                                        <Field as="text" name="description" value={values.description} onChange={handleChange} maxLength={100} placeholder="Description" className={'form-control' + (errors.description && touched.description ? ' is-invalid' : '')}/>
                                                        <ErrorMessage name="description" component="div" className="invalid-feedback" />
                                                    </div>
                                                </div>
                                                <div className="form-group row">
                                                    <label className="col-md-4 control-label"> Level Two Seller Ratings % : </label>
                                                    <div className="col-md-6">
                                                        <Field type="text" id="title" name="title" value={values.title} onChange={handleChange} maxLength={100} placeholder="Title" className={'form-control' + (errors.title && touched.title ? ' is-invalid' : '')} />
                                                        <ErrorMessage name="title" component="div" className="invalid-feedback" />
                                                    </div>
                                                ...
                                                <div className="form-group row">
                                                    <label className="col-md-4 control-label"> Level Two Completed Orders : </label>
                                                    <div className="col-md-6">
                                                        <Field as="text" name="description" value={values.description} onChange={handleChange} maxLength={100} placeholder="Description" className={'form-control' + (errors.description && touched.description ? ' is-invalid' : '')}/>
                                                        <ErrorMessage name="description" component="div" className="invalid-feedback" />
                                                    </div>
                                                ...
                                                <div className="form-group row">
                                                    <label className="col-md-4 control-label"> Top Rated Seller Ratings % : </label>
                                                    <div className="col-md-6">
                                                        <Field type="text" id="title" name="title" value={values.title} onChange={handleChange} maxLength={100} placeholder="Title" className={'form-control' + (errors.title && touched.title ? ' is-invalid' : '')} />
                                                        <ErrorMessage name="title" component="div" className="invalid-feedback" />
                                                    </div>
                                                ...
                                                <div className="form-group row">
                                                    <label className="col-md-4 control-label"> Top Rated Completed Orders : </label>
                                                    <div className="col-md-6">
                                                        <Field as="text" name="description" value={values.description} onChange={handleChange} maxLength={100} placeholder="Description" className={'form-control' + (errors.description && touched.description ? ' is-invalid' : '')}/>
                                                        <ErrorMessage name="description" component="div" className="invalid-feedback" />
                                                    </div>
