...
const Skill = () => {
  ...
  return (
    <Fragment>
      <h1 className="h3 mb-2 text-gray-800">Skills</h1>
      <p className="mb-4">Skill List</p>
      <div className="row">
        <Link className="btn btn-primary" style={{ float: "right" }} to="/admin/skill/add">Add Skill</Link>
        ...
        <div className="col-xl-12 col-lg-12">
          <div className="card shadow mb-4">
            <div className="card-header py-3">
              <h6 className="m-0 font-weight-bold text-green">Skill List</h6>
