...
import { deleteCancelReason, changeCancelReasonStatus } from "../../../../_actions/admin/cancelReason.action";
...
const Category = () => {
  ...
  useEffect(() => {
    ...
    $('body').on('click', '.edit', function (e) {
      e.preventDefault();
      history.push('/admin/cancel/reason/' + $(this).data('id') + '/edit')
    });
    ...
    $('body').on('click', '.delete', function (e) {
      ...
      $(".delete-modal-btn")
        .off()
        .on("click", function () {
          dispatch(deleteCancelReason(sid)).then(res => {
    ...
    $('#datatable').DataTable({
      ...
      "ajax": {
        ...
        dataFilter: function (response) {
          ...
          json.data = data.responseData.data.CancelReasons;
          console.log(json);
    ...
    $('body').on('change', '.status_enable', function () {
      ...
      dispatch(changeCancelReasonStatus(id, value)).then(res => {
            ...
            <div className="col-sm-12">
              <div className="page-header">
                <div className="page-title">
                  <h1><i className="menu-icon fa fa-cubes"></i> Cancel Reasons </h1>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="box box-block bg-white">
              <h5 className="mb-1">Cancel Reasons
                <div className="rightBtn-Group">
                  <Link className="addMoreBtn" to="/admin/cancel/reason/add" ><span className="txt text-capitalize"> Add New <span className="amIcon"><i className="fa fa-plus"></i></span></span></Link>
                </div>
              </h5>
              <div className="">
