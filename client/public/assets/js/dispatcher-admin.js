                    ...
                    <div className="row">
                        ...
                        <div className="col-xs-12">
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" className="form-control" name="schedule_time" id="schedule_time" autoComplete="off" placeholder="Date"/>
                            </div>
                            <div className="form-group">
                   ...
                   <table className="table table-bordered">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>â‚¹{this.props.estimateview.estimated_fare}</td>
                      </tr>
                    </tbody>
                  </table>
                    <div className="row">
